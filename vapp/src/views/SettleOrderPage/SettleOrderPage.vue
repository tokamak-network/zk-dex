...
export default {
  ...
  methods: {
    makeNotesForSettle() {
      this.rewardNote = new Note(takerNote.hash(), makerNote.value, constants.DAI_TOKEN_TYPE, takerVk, web3Utils.randomHex(16), true);
      this.paymentNote = new Note(makerNote.hash(), takerNote.value, constants.ETH_TOKEN_TYPE, takerVk, web3Utils.randomHex(16), true);
      this.changeNote = new Note(makerNote.hash(), ether('0'), constants.ETH_TOKEN_TYPE, makerVk, web3Utils.randomHex(16), true);
    },
    generateProof() {
      this.loading = true
      dockerUtils.getSettleOrderProof(
        makerNote,
        stakeNote,
        this.rewardNote,
        this.paymentNote,
    ...
    settleOrder() {
      const e = rlp.encode([this.rewardNote.encrypt(), this.paymentNote.encrypt(), this.changeNote.encrypt()])
