...
contract Market is ZkDai {
  ...
  function makeOrder(
    ...
    require(notes[makerNote] == State.Valid, "Market: maker note is not available");
  ...
  function takeOrder(
    ...
    require(notes[parentNote] == State.Valid, "Market: taker note is not available");
  ...
  function settleOrder(
    ...
    require(notes[takerNoteToMaker] == State.Valid, "Market: taker note is not available");

    notes[newNoteToMaker] = State.Valid;
    notes[newNoteToTaker] = State.Valid;
    notes[changeToMaker1] = State.Valid;
    notes[changeToMaker2] = State.Valid;
